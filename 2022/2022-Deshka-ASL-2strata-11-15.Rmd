---
title: "2022 Deshka Weir - Chinook - 2 strata"
...
strat1 <- interval(ymd("2022-05-31 UTC"),ymd("2022-06-20 UTC"))   #Adjust Begin and end dates for strata
strat2 <- interval(ymd("2022-06-21 UTC"),ymd("2022-08-08 UTC"))
...
Likelihood ratio tests indicate age composition *did not* differ between time strata. Note that removing the 1.4 age class reduces the p-value to 0.057. 
...
saveWorkbook(WB, ".//22 Deshka ASL_LFW11_14_2strata.xlsx", overwrite = TRUE)
